...
class CEqMemDC : public CDC
{
public:

    // constructor sets up the memory DC
    CEqMemDC(CDC* pDC) : CDC()
    {
        ASSERT(pDC != NULL);
    ...
    CEqMemDC* operator->() {return this;}
        
    // Allow usage as a pointer
    operator CEqMemDC*() {return this;}

private:
    CBitmap  m_bitmap;      // Offscreen bitmap
    CBitmap* m_pOldBitmap;  // bitmap originally found in CEqMemDC
